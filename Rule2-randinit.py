...
if os.path.exists('./Heatmap_rule2_tempdecrease_10000/')==False:
    os.mkdir('./Heatmap_rule2_tempdecrease_10000/')
...
for turn in range(10000):
    ...
    plt.savefig('./Heatmap_rule2_tempdecrease_10000/heatmap_%d.png'%turn,format='png',dpi=320)
    #plt.show()
    plt.close()
    
    #time.sleep(.1)
np.save('transfer_list_rule2_tempdecrease_10000.npy',np.array(transfer_list_rule2))
