...
if os.path.exists('./Heatmap_2ndrule_1000-123-temp01-fixgenreq-tempdesc10/')==False:
    os.mkdir('./Heatmap_2ndrule_1000-123-temp01-fixgenreq-tempdesc10/')
...
for turn in range(1000):
    ...
    plt.savefig('./Heatmap_2ndrule_1000-123-temp01-fixgenreq-tempdesc10/heatmap_%d.png'%turn,format='png',dpi=320)
    #plt.show()
    plt.close()
...
np.save('transfer_list_rule2_1000_123_fixgenreq_temp01_tempdesc10.npy',np.array(transfer_list_rule2))
np.save('response_list_rule2_1000_123_fixgenreq_temp01_tempdesc10.npy',np.array(response_list_rule2))
np.save('request_list_rule2_1000_123_fixgenreq_temp01_tempdesc10.npy',np.array(request_list))
np.save('Tier_list_rule2_1000_123_fixgenreq_temp01_tempdesc10.npy',np.array(tier_list))