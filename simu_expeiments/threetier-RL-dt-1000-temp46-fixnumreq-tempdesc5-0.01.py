...
if os.path.exists('./Heatmap_RL_10100init123-1000-temp46-fixnumreq-tempdesc5-0.01/')==False:
    os.mkdir('./Heatmap_RL_10100init123-1000-temp46-fixnumreq-tempdesc5-0.01/')
...
for turn in range(1000):
    ...
    plt.savefig('./Heatmap_RL_10100init123-1000-temp46-fixnumreq-tempdesc5-0.01/heatmap_%d.png'%turn,format='png',dpi=320)
    #plt.show()
    plt.close()
...
np.save('transfer_list_RL_1000_fixnumrandpoireq_10100init123_temp46_tempdesc5_0.01.npy',np.array(transfer_list_RL))
np.save('response_list_RL_1000_fixnumrandpoireq_10100init123_temp46_tempdesc5_0.01.npy',np.array(response_list))
np.save('request_list_RL_1000_fixnumrandpoireq_10100init123_temp46_tempdesc5_0.01.npy',np.array(request_list))
np.save('Tier_list_RL_1000_fixnumrandpoireq_10100init123_temp46_tempdesc5_0.01.npy',np.array(tier_list))