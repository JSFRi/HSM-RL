...
if os.path.exists('./Heatmap_RL_zeroinit123-1000-temp46-fixgenreq-tempdesc10/')==False:
    os.mkdir('./Heatmap_RL_zeroinit123-1000-temp46-fixgenreq-tempdesc10/')
...
for turn in range(1000):
    ...
    plt.savefig('./Heatmap_RL_zeroinit123-1000-temp46-fixgenreq-tempdesc10/heatmap_%d.png'%turn,format='png',dpi=320)
    #plt.show()
    plt.close()
...
np.save('transfer_list_RL_1000_fixgenreq_zeroinit123_temp46_tempdesc10.npy',np.array(transfer_list_RL))
np.save('response_list_RL_1000_fixgenreq_zeroinit123_temp46_tempdesc10.npy',np.array(response_list))
np.save('s123_list_RL_1000_fixgenreq_zeroinit123_temp46_tempdesc10.npy',np.array([s1t1_list,s2t1_list,s3t1_list,s1t2_list,s2t2_list,s3t2_list,s1t3_list,s2t3_list,s3t3_list]))
np.save('request_list_RL_1000_fixgenreq_zeroinit123_temp46_tempdesc10.npy',np.array(request_list))
np.save('Tier_list_RL_1000_fixgenreq_zeroinit123_temp46_tempdesc10.npy',np.array(tier_list))
np.save('p_list_RL_1000_fixgenreq_zeroinit123_temp46_tempdesc10.npy',np.array(p_list))