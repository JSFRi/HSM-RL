...
#load tier tables
tier_list=np.load('./Tier_list_rule3_20000_123_fixgenreq_temp46_tempdesc10.npy',allow_pickle=True)
...
def hot_cold_rule3(tier,file):
    ...
    if float(file['weight']/file['req_time'])<20000:
...
if os.path.exists('./Heatmap_3rdrule_20000+20000-123-temp46-fixgenreq-tempdesc10/')==False:
    os.mkdir('./Heatmap_3rdrule_20000+20000-123-temp46-fixgenreq-tempdesc10/')
...
for turn in range(1000):
    ...
    plt.savefig('./Heatmap_3rdrule_20000+20000-123-temp46-fixgenreq-tempdesc10/heatmap_%d.png'%turn,format='png',dpi=320)
    #plt.show()
    plt.close()
...
np.save('transfer_list_rule3_20000+20000_123_fixgenreq_temp46_tempdesc10.npy',np.array(transfer_list_rule3))
np.save('response_list_rule3_20000+20000_123_fixgenreq_temp46_tempdesc10.npy',np.array(response_list_rule3))
np.save('request_list_rule3_20000+20000_123_fixgenreq_temp46_tempdesc10.npy',np.array(request_list))
np.save('Tier_list_rule3_20000+20000_123_fixgenreq_temp46_tempdesc10.npy',np.array(tier_list))